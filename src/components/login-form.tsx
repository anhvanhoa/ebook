...
import { defaultLogin, formSchema, FormSchema } from '@/schema/auth';
...
export function LoginForm({ className, ...props }: React.ComponentProps<'div'>) {
    ...
    const onSubmit = (values: FormSchema) => login.mutate(values);
    return (
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className='p-6 md:p-8'>
                            <div className='flex flex-col gap-6'>
                                ...
                                <Button type='submit' className='w-full cursor-pointer' disabled={login.isPending}>
                                    {login.isPending && <Loader className='ml-2 h-4 w-4 animate-spin' />}
